...
##############################################################
    ...
    # audio =  AudioSegment.from_wav(os.path.join('tmp','voice_recording.wav'))
    ...
    return render_template('audio.html', display_button=True,name=name,text=text)
    ...
    # return render_template('audio.html', display_button=True,name=name,text=whole_text)


# Audio Emotion Analysis
@app.route('/audio_analysis_interview', methods=("POST", "GET"))
def audio_analysis_interview():
